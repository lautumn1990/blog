...
```sh
sudo docker run -d --privileged --restart=unless-stopped --net=host -v /etc/kubernetes:/etc/kubernetes -v /var/run:/var/run  rancher/rancher-agent:v2.6.2 --server https://192.168.205.161 --token dv48n7zw6ktmszqfzwv8tg2x6jmbldxdgvhswjcfjls2hfvnlwvggj --ca-checksum 65e8326e19d8f7072c503775b4d5c871237823da179701ee33120ef14049f3be --etcd --controlplane --worker
```

### 通过docker安装rancher cluster卸载
